...
- `ALAYA_PART_OF_STRICT=strict` remains the required operator posture/default for `part_of` hierarchy enforcement; this sprint does not add a runtime `/admin/flags` endpoint.
