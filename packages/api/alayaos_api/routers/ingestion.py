...
async def ingest_text(
    ...
    # Rate limiting: ingest triggers LLM extraction — cap per-key spend.
    # Fail-closed on Redis outage so a single valid write-key cannot
    # drain LLM budget during infra degradation.
    redis_client = None
