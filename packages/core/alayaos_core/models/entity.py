...
class L1Entity(Base, TimestampMixin):
    ...
    entity_type: Mapped["alayaos_core.models.entity_type.EntityTypeDefinition"] = relationship(
        "EntityTypeDefinition", lazy="select"
    )
...
class EntityExternalId(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "workspace_id", "entity_id", "source_type", "external_id",
