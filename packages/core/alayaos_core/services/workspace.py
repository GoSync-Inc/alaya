...
CORE_PREDICATES = [
    ...
    {"slug": "status", "display_name": "Status", "value_type": "text", "supersession_strategy": "latest_wins"},
    {"slug": "owner", "display_name": "Owner", "value_type": "entity_ref", "supersession_strategy": "explicit_only"},
    {"slug": "role", "display_name": "Role", "value_type": "text", "supersession_strategy": "explicit_only"},
    {"slug": "title", "display_name": "Title", "value_type": "text", "supersession_strategy": "explicit_only"},
    {
        "slug": "member_of",
    ...
    {"slug": "priority", "display_name": "Priority", "value_type": "text", "supersession_strategy": "latest_wins"},
    {"slug": "budget", "display_name": "Budget", "value_type": "number", "supersession_strategy": "latest_wins"},
    {"slug": "decision", "display_name": "Decision", "value_type": "text", "supersession_strategy": "latest_wins"},
    {
        "slug": "description",
    ...
    {"slug": "location", "display_name": "Location", "value_type": "text", "supersession_strategy": "accumulate"},
    {"slug": "start_date", "display_name": "Start Date", "value_type": "date", "supersession_strategy": "latest_wins"},
    {"slug": "end_date", "display_name": "End Date", "value_type": "date", "supersession_strategy": "latest_wins"},
    {
